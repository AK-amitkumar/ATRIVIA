...
class ResCompany(models.Model):
    ...
    def _default_report_template(self):
        ...
        partner_portal_public_rule =self.env.ref('base.res_partner_portal_public_rule')
        if partner_portal_public_rule:
            self.env.cr.execute('delete from ir_rule where id = %s' % partner_portal_public_rule.id)
